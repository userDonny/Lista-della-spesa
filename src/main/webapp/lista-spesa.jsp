	    ...
	    <h1 style = "font-family: 'Sofia', sans-serif;background-color: rgb(235, 196, 113);" class = "text-center">Lista della spesa</h1>
	      ...
	      <% for (ListaSpesaProdotto element :listaSpesa.getListaSpesaProdotto()) {%>
	          ...
	          <div class="card-body"> <!-- Card body -->
	          	<a class="stretched-link link-underline link-underline-opacity-0" href=""><span style="color:black"><span style="font-weight: 4; font-size:30px"></span><%= element.getProdotto().getNome()%><span style="font-weight: 4; font-size:40px"> /prezzo/ &#8364;</span></span></a>
	           ...
	           <!-- X -->
	        <button class="btn btn-link link-secondary link-underline link-underline-opacity-0" type="submit"> Rimuovi
	        ...
	        <!-- <c:forEach var="prodotto" items="${prodotti}">
	          ...
	          <div class="row">
	          <div class="col-3">
	          <img class = "mx-auto" src="${prodotto.linkFotoSmall}" height= "200" width = "200">
	          </div>
	          <div class="col-9">
	          <div class="card-body">
	          	<a class="stretched-link link-underline link-underline-opacity-0" href=""><span style="color:black"><span style="font-weight: 4; font-size:30px">/nome/ </span><span style="font-weight: 4; font-size:40px"> /prezzo/ &#8364;</span></span></a>
	        ...
	        <div class="col-3" style="background-color:rgb(235, 196, 113)"> <!-- Spazio per Card Totale -->
	        	...
	        	<h3 class="card-title">Totale: <span class="card-text" style = "font-weight: 4; font-size:30px;">/totale/ &#8364;</span></h3>
	          		<!--   <p class="card-text" style = "font-weight: 4">/totale/ &#8364;</p> -->
	        </div>
