...
<body class="text-center">
	<main class="form-signin w-100 m-auto">
		<form method="post" action="save-utente">
			<img src="immagini/trasparente_2.png" alt="" width="230" height="230">
			...
			<button class="w-100 btn btn-lg btn-primary" type="submit">Crea account</button>
		</form>
		<br>
		<c:if test="${errorUser != null}">
			 <div class="alert alert-danger" role="alert">
			 	 Username o email esistenti. Scegline altri!
			</div>
		</c:if>
	</main>
</body>
